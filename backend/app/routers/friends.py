...
def build_public_profile(user_id: str) -> FriendProfileResponse | None:
    ...
    return FriendProfileResponse(
        ...
        dailyTotalTime=int(summary.get("dailyTotalMinutes", 0) or 0),
        weeklyTotalTime=int(summary.get("weeklyTotalMinutes", 0) or 0),
        monthlyTotalTime=int(summary.get("monthlyTotalMinutes", 0) or 0),
        yearlyTotalTime=int(summary.get("yearlyTotalMinutes", 0) or 0),
